...
namespace Merge
{
    public class PopupManager : MonoBehaviour
    {
        ...
        private List<Pop> currentPops = new();
        ...
        {
            Label popLabel = new() { name = "PopLabel" + newText, text = newText };
            ...
            List<EasingFunction> easings = new();
        ...
        IEnumerator PopText(string newText, Vector2 pos, bool single, string soundName = "", bool fromSelector = false)
        {
            ...
            popupLabel.style.paddingBottom = 0;
            popupLabel.style.visibility = Visibility.Hidden;
