    ...
    public class ProgressManager : MonoBehaviour
    {
        ...
        void OnValidate()
        {
            if (addTask)
            {
                ...
                taskManager.AddTask(currentProgress.currentStepContentId = progressData.areas[0].steps[0].content[0].id, progressData.areas[0].id);
            }
        }
        ...
        public void CheckInitialData()
        {
            ...
            {
                currentProgress = JsonConvert.DeserializeObject<CurrentProgress>(PlayerPrefs.GetString("currentProgress"));
            }
            else
            {
                ...
                PlayerPrefs.SetString("currentProgress", JsonConvert.SerializeObject(currentProgress));
            }
