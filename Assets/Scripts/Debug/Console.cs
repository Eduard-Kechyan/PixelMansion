...
namespace Merge
{
    ...
    public class Console : MonoBehaviour
    {
        ...
        [
            SerializeField,
            Tooltip(
                "Whether to keep a limited number of logs. Useful if memory usage is a concern."
            )
        ]
        ...
        static readonly GUIContent clearLabel = new GUIContent(
            "Clear",
            "Clear contents of console."
        );
        static readonly GUIContent onlyLastLogLabel = new GUIContent(
            "Only Last Log",
            "Show only most recent log."
        );
        static readonly GUIContent collapseLabel = new GUIContent(
            "Collapse",
        ...
        void DrawLogList()
        {
            ...
            if (
                ...
                && IsScrolledToBottom(innerScrollRect, outerScrollRect)
            )
            {
                ScrollToBottom();
            }
        ...
        void DrawToolbar()
        {
            GUILayout.BeginHorizontal();
            {
                ...
                isCollapsed = GUILayout.Toggle(
                    isCollapsed,
                    collapseLabel,
                    GUILayout.ExpandWidth(false)
                );
                onlyLastLog = GUILayout.Toggle(
                    onlyLastLog,
                    onlyLastLogLabel,
                    GUILayout.ExpandWidth(false)
                );
